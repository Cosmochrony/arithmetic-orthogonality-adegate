...
\begin{document}
  ...
  \begin{abstract}
    ...
    The no-go for the ADE gate is therefore unconditional in the present construction; only the abstract type-rigidity
    of the full recursive tower remains open, and it is broader than the gate requires.
  \end{abstract}
...
Theorem~\ref{thm:negative} does not depend on it.
  ...
  \section{Status and downstream consequence}
    ...
    The epistemic stratification of the seven statements is as follows.
